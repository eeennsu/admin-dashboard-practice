...
export type CreateTaskMutation = {
    createOneTask: Pick<Types.Task, 'id' | 'title'> & { stage?: Types.Maybe<Pick<Types.TaskStage, 'id' | 'title'>> }
}
...
export type UsersSelectQuery = {
    users: Pick<Types.UserConnection, 'totalCount'> & { nodes: Array<Pick<Types.User, 'id' | 'name' | 'avatarUrl'>> }
}
...
export type TaskStagesQuery = {
    taskStages: Pick<Types.TaskStageConnection, 'totalCount'> & { nodes: Array<Pick<Types.TaskStage, 'id' | 'title'>> }
}
