...
import { ContactStatusTag } from '@/components/company/edit/ContactStatusTag'
import { selectGenerator } from '@/lib/utils'
import { COMPANY_BUSINESS_TYPE_OPTIONS } from '@/lib/constants'
                    ...
                    filterDropdown={(props) => (
                        <FilterDropdown {...props}>
                            <Select
                                ...
                                options={selectGenerator(COMPANY_BUSINESS_TYPE_OPTIONS)}></Select>
                        </FilterDropdown>
                    )}
                />
                <Table.Column<Contact>
